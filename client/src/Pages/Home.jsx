  ...
  return (
    <div>
      ...
      <div 
        ...
        className="text-[30px] flex justify-center bg-yellow-500 h-[250px] w-[500px] rounded-md shadow-gray-400 items-center cursor-pointer"
      >
        Buy
      </div>
      <div 
        onClick={() => navigate('/sell')}
        className="text-[30px] flex justify-center items-center bg-yellow-500 h-[250px] w-[500px] rounded-md shadow-gray-400 cursor-pointer"
      >
        Sell
      </div>
    </div>
